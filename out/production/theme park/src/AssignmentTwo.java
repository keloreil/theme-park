...
public class AssignmentTwo {
    ...
    public void partThree() {
        Ride ride = new Ride("Roller Coaster", new Employee("John", 30, "E001", "Operator", 50000.0), 2);
    ...
    public void partFourA() {
        Ride ride = new Ride("Ferris Wheel", new Employee("Jane", 28, "E002", "Operator", 50000.0), 4);
    ...
    public void partFourB() {
        Ride ride = new Ride("Carousel", new Employee("Alice", 28, "E003", "Operator", 45000.0), 3);
    ...
    public void partSeven() {
        Ride ride = new Ride("Merry-Go-Round", new Employee("Dave", 32, "E004", "Operator", 48000.0), 3);
